...
public class SomePracticeStringMethodsTest {
	...
	public void testIndexOfFirstTULetterString() {
		...
		assertEquals(SomePracticeStringMethods.indexOfFirstTULetter("cat"), 2);
	...
	public void testIndexOfFirstTULetterStringInt() {
		...
		assertEquals(SomePracticeStringMethods.indexOfFirstTULetter("caterpillar", 4), 5);
	...
	public void appendIfMissing() {
		...
		assertEquals("sippycup", SomePracticeStringMethods.appendIfMissing("sippycup", "cup"));
		assertEquals("undertow", SomePracticeStringMethods.appendIfMissing("under", "tow"));
	}
